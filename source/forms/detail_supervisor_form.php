...
class detail_supervisor_form extends moodleform {
    ...
    public function definition() {
        ...
        #Header
        $mform->addElement('header', 'header', 'Betreuer an- oder ablehnen');
        ...
        #Comment
        $mform->addElement('textarea', 'comment', 'Kommentar*'); // Add elements to your form
        ...
        #Button---------------------------------------------------------------------------------
        $mform->addElement('submit', 'btnquit', 'Abbrechen');
        $mform->addElement('submit', 'btnsave', 'Speichern');
